...
public class Userdata {
    @Column
//    @Schema(description = "First name of the user",required = true,example="user_firstname")
    @NotBlank(message="First name should not be empty")
    private String firstname;
    @Column
//    @Schema(description = "Last name of the user",required = true,example="user_lastname")
